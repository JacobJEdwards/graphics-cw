...
public:
    ...
    Shader(std::string vertexPath, std::string fragmentPath,
           std::string geometryPath = "", std::string tessControlPath = "", std::string tessEvalPath = "") : vertexPath(std::move(vertexPath)), fragmentPath(std::move(fragmentPath)), geometryPath(std::move(geometryPath)), tessControlPath(std::move(tessControlPath)), tessEvalPath(std::move(tessEvalPath)){
        load();
    }
